	...
	namespace core
	{
		...
		class string
		{
			...
			public:
				...
				string<T, TAlloc> operator+(
						const string<T, TAlloc>& other) const
				{
				...
				/** \param other: Other string to compare.
				 ...
				 \return True if the strings are equal ignoring case. */
				bool equals_substring_ignore_case(const string<T, TAlloc>&other,
						const s32 sourcePos = 0) const
				{
				...
				u32 split(container& ret, const T* const c, u32 count = 1,
