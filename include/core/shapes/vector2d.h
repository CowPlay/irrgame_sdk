	...
	namespace core
	{
		...
		class vector2d
		{
			...
			public:
				...
				{
					return (_X < other._X
							|| core::SharedMath::getInstance().equals(_X,
									other._X))
							|| (core::SharedMath::getInstance().equals(_X,
									other._X)
									&& (_Y < other._Y
				...
				f32 getAngleTrig() const
				{
					...
					if (_Y > 0)
						if (_X > 0)
							return atan(_Y / _X) * SharedMath::RadToDeg;
						else
							return 180.0 - atan(_Y / -_X) * SharedMath::RadToDeg;
					else if (_X > 0)
						return 360.0 - atan(-_Y / _X) * SharedMath::RadToDeg;
					else
						return 180.0 + atan(-_Y / -_X) * SharedMath::RadToDeg;
				}
