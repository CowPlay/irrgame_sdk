...
namespace irrgame
{
	namespace video
	{
		...
		bool SVideoMode::operator==(const SVideoMode& other) const
		{
...
//
//		void CVideoModeList::setDesktop(s32 desktopDepth,
...
//				const u32 dist = core::min_(abs(int(minArea - area)),
//						abs(int(maxArea - area)));
//				if (dist < minDist)
//				{
//					minDist = dist;
//					best = i;
...
//		void CVideoModeList::addMode(const core::dimension2d<u32>& size,
//				s32 depth)
//		{
//			SVideoMode m;
//			m.depth = depth;
